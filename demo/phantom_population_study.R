...
m + geom_histogram(aes(y = ..density..), binwidth = 0.05, colour = "black", fill = "white") + 
  geom_density(alpha = 0.2, fill = "#FF6666")



plotANTsImage(myantsimage = antsImageRead(maskfn, mydim), functional = betaimg, threshold = "2x6", 
  color = "red", axis = 1)
