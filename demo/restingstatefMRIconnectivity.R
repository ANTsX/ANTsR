...
myres <- filterfMRIforNetworkAnalysis(img, tr = 4, 0.03, 0.09, cbfnetwork = "BOLD", 
  smoother = 1, moreaccurate = FALSE, maskThresh = 1e+05)
# check if the mask is ok
plotANTsImage(myantsimage = avg, functional = myres$mask, slices = "12x33x3", axis = 3, 
  threshold = "0.5x1.5")
