...
simparms = simlr.parameters( 
    ...
    prescaling_options = list( 
            c( "centerAndScale",  "np") ),
    objectiver_options = list("regression",'acc','normalized_correlation','lrr'),
    mixer_options=list("ica",'pca','svd'), 
    ...
    optimus_options=list( "adam",  'adagrad' ),
...
simlrXs=simlr.search(
        ...
        regs=regs,
        simparms,
        nperms=20, # just fast for vignette
        verbose=1
        )
# simlrXs$paramsearch
```
