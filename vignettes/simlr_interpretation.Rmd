...
This section of the tutorial vignette provides an example of how to set up and run a parameter search using the simlr.search function for the Similarity-driven multi-view linear reconstruction (SiMLR) algorithm.  Here, `csearch` creates a list of constraint options that include "none" and different options for enforcing orthogonality. This list will be used to explore different constraint options during the parameter search.
