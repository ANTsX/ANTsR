...
if ( ! exists("real_A") | ! exists("real_B") | TRUE ) {
    ...
    real_B <- nsa_flow_fa( data = bfi_data_tx, nfactors = 5, max_iter = 50, rotate = rot, nsa_w = nsaval, optimizer = myo, nsa_max_iter = nsa_max_iter, apply_nonneg = nn)
...
# ---- Method B: NSA.FA ----
real_B_train <-nsa_flow_fa( data = train_data, nfactors = 5, max_iter = 50,
