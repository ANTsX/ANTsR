...
An `AffineTransform` is created and defined by setting its parameters. These parameters
are the components of the matrix, in row order, followed by the translation components.
...
Sets of points may be transformed using `apply` and its variants.
