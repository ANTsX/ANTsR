...
#' is similar patch-based dictionary learning in N-dimensions.
...
#' ripped <- ripmmarc( img, msk, 3 )
#' @export smoothImage
ripmmarc <- function( img, mask, patchRadius = 3, patchSamples = 1000 ) {
  ...
  outimg <- .Call("patchAnalysis",
    inimg.float, mask.float, outimg, patchRadius, patchSamples,
    PACKAGE = "ANTsR")
