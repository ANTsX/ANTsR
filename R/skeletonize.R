...
#' @export skeletonize
#'
skeletonize <- function( x, propagationOption = 1 ) {
# ImageMath 3 wm.nii.gz MD wm.nii.gz 1  ImageMath 3 wm.nii.gz ME wm.nii.gz 1
  wm = iMath( x, "MD", 1 ) %>% iMath( "ME", 1)
  wm = thresholdImage( wm, 0, 0 ) #  ImageMath 3 wm.nii.gz Neg wm.nii.gz
  ...
  speed = thresholdImage( wmdl, 0.0, 0.25 ) # ThresholdImage 3 wmdl.nii.gz speed.nii.gz 0.0 0.25
