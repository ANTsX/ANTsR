...
setMethod(
  ...
  definition = function(x, i, j, ..., value) {
    ...
    return(ANTsRCore::antsImage_SetRegion(x, mask, region, value))
  }
)
...
setMethod(
  ...
  definition = function(x, i, j, ..., value) {
    ...
    return(ANTsRCore::antsImage_SetRegion(x, i, region, value))
  }
)
...
setMethod(
  ...
  definition = function(x, i, j, ..., value) {
    mask <- logical(0)
    return(ANTsRCore::antsImage_SetRegion(x, mask, j, value))
  }
)
...
setMethod(
  ...
  definition = function(x, i, j, ..., value) {
    return(ANTsRCore::antsImage_SetRegion(x, i, j, value))
  }
)
