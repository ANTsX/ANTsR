...
#' }
#' @export
functionalLungSegmentation <- function(
    image, mask, numberOfIterations = 2,
  ...
  for (i in seq.int(numberOfAtroposN4Iterations))
  {
    ...
    atroposOutput <- atropos(preprocessedImage,
      x = mask, i = atroposInitialization,
  ...
  return(list(
    segmentationImage = maskedSegmentationImage,
