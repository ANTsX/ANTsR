...
#' @param interpolator choose the Linear, NearestNeighbor, MultiLabel or any
...
#' fixed<-resampleImage(fixed,c(128,128),1,0)
#' moving<-resampleImage(moving,c(128,128),1,0)
...
antsApplyTransforms <- function(fixed = NA, moving = NA,
