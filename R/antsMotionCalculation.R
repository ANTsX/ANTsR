...
#' Correct ASL data for motion.
#'
#' Correct ASL data for motion.
#'
#'
#' @param img Name of image file, e.g. 'img.nii.gz'.
#' @param mask Name of mask file, e.g. 'mask.nii.gz'.  If not provided,
#' estimated from data.
#' @param fixed Fixed image to register all timepoints to.  If not provided,
#' mean image is used.
#' @param moreaccurate Level of accuracy desired for motion correction.  Higher
#' is more accurate.
#' @param framewise Calculate framewise displacement?
