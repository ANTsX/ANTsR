...
#' snpdFast<-networkEiganat( as.matrix( snps[train,] ), nvecs=20 ,
#'   sparseness=c( 1, -0.001 ) , downsample=45, verbose=T, its=20,
#'   gradparam=10 )
#' snpdSlow<-networkEiganat( as.matrix( snps[train,] ), nvecs=20 ,
