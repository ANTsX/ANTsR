# Following are the parameters used in the ASLtbx First image: label Subtraction Method: simple subtraction
...
# voxels: no Output Image Format: nifti Saving 4D Image Series: yes Select ASL type: PASL Magnetic Field: 3T
# Post-Labeling Delay Time (sec): 0.8 Slice Acquisition Time (msec): 45 TE (msec): 20 Select M0 Image: m0.nii
# Draw ROI for calculating CBF: yes Label Efficiency: 0.95
# --------------------------------------------------------------------------------------
