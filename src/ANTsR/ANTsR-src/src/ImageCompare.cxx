...
try
{
  ...
  try
    ...
    {
    Rcpp::Rcout << "ITK test driver caught an ITK exception:\n";
    Rcpp::Rcout << e.GetFile() << ":" << e.GetLine() << ":\n"
              << e.GetDescription() << "\n";
    bestBaselineStatus = -1;
    }
  catch(const std::exception& e)
    {
    Rcpp::Rcout << "ITK test driver caught an exception:\n";
    Rcpp::Rcout << e.what() << "\n";
    bestBaselineStatus = -1;
    }
  catch(...)
    {
    Rcpp::Rcout << "ITK test driver caught an unknown exception!!!\n";
    bestBaselineStatus = -1;
    }
  Rcpp::Rcout << bestBaselineStatus << endl;
  ...
  return Rcpp::wrap( bestBaselineStatus ) ;
}
                         ...
                         int reportErrors, bool differences)
{
  ...
  try
    ...
    {
    Rcpp::Rcout << "Exception detected while reading " << baselineImageFilename << " : "  << e.GetDescription();
    return 1000;
    }
  ...
  try
    ...
    {
    Rcpp::Rcout << "Exception detected while reading " << testImageFilename << " : "  << e.GetDescription() << std::endl;
    return 1000;
    }
  ...
  if (baselineSize != testSize)
    {
    Rcpp::Rcout << "The size of the Baseline image and Test image do not match!" << std::endl;
    Rcpp::Rcout << "Baseline image: " << baselineImageFilename
              << " has size " << baselineSize << std::endl;
    Rcpp::Rcout << "Test image:     " << testImageFilename
  ...
  if (reportErrors)
    ...
    if(differences)
      ...
      Rcpp::Rcout << "<DartMeasurement name=\"ImageError\" type=\"numeric/double\">";
      Rcpp::Rcout << status;
      Rcpp::Rcout <<  "</DartMeasurement>" << std::endl;
      ...
      try
        ...
        {
        Rcpp::Rcout << "Error during rescale of " << diffName.str() << std::endl;
        }
      ...
      try
        ...
        {
        Rcpp::Rcout << "Error during write of " << diffName.str() << std::endl;
        }

      Rcpp::Rcout << "<DartMeasurementFile name=\"DifferenceImage\" type=\"image/png\">";
      Rcpp::Rcout << diffName.str();
      Rcpp::Rcout << "</DartMeasurementFile>" << std::endl;
      }
    ...
    try
      ...
      {
      Rcpp::Rcout << "Error during rescale of " << baseName.str() << std::endl;
      }
    try
      {
      ...
      {
      Rcpp::Rcout << "Error during write of " << baseName.str() << std::endl;
      }

    Rcpp::Rcout << "<DartMeasurementFile name=\"BaselineImage\" type=\"image/png\">";
    Rcpp::Rcout << baseName.str();
    Rcpp::Rcout << "</DartMeasurementFile>" << std::endl;
    ...
    try
      ...
      {
      Rcpp::Rcout << "Error during rescale of " << testName.str()
                << std::endl;
      }
    try
      {
      ...
      {
      Rcpp::Rcout << "Error during write of " << testName.str() << std::endl;
      }

    Rcpp::Rcout << "<DartMeasurementFile name=\"TestImage\" type=\"image/png\">";
    Rcpp::Rcout << testName.str();
    Rcpp::Rcout << "</DartMeasurementFile>" << std::endl;
