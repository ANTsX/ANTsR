...
RcppExport SEXP ConvertImagePixelType( SEXP r_args )
try
{
  ...
  if ( argc < 3 )     
    { Rcpp::Rcout << "Usage:   " << argv[0] << " infile.nii out.ext TYPE-OPTION " << std::endl;
      Rcpp::Rcout <<" ext is the extension you want, e.g. tif.  " << std::endl;
      Rcpp::Rcout << " TYPE-OPTION  :  TYPE " << std::endl;
      Rcpp::Rcout << "  0  :  char   " << std::endl;
      Rcpp::Rcout << "  1  :  unsigned char   " << std::endl;
      Rcpp::Rcout << "  2  :  short   " << std::endl;
      Rcpp::Rcout << "  3  :  unsigned short   " << std::endl;
      Rcpp::Rcout << "  4  :  int   " << std::endl;
      Rcpp::Rcout << "  5  :  unsigned int   " << std::endl;
      Rcpp::Rcout << " Note that some pixel types are not supported by some image formats. e.g.  int is not supported by jpg. " << std::endl;
      Rcpp::Rcout << " You can easily extend this for other pixel types with a few lines of code and adding usage info. " << std::endl;
      Rcpp::Rcout <<" The image intensity will be scaled to the dynamic range of the pixel type.  E.g. uchar => 0  (min), 255 (max). " << std::endl;
