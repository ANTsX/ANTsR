/*=========================================================================
  ...
  Module:    $RCSfile: itkDiReCTImageFilter953.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkDiReCTImageFilter953_h
#define __itkDiReCTImageFilter953_h
...
public:
  ...
  typedef DiReCTImageFilter953                               Self;
...
private:
   ...
   */
  VectorImagePointer SmoothDisplacementField( const VectorImageType *,
    const RealType );
...
#include "itkDiReCTImageFilter953.hxx"
#endif
