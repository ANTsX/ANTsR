...
template<int D> struct Dispatcher {
};


template<class TAffine> struct HelperCommonType{
    ...
    static void ComputeAveragePartialParameters(InternalTransformListType &transform_list,
            ParametersType &average_parameters, unsigned int iStart, unsigned int iEnd);
...
template<class T> class HelperType;
...
//public:
    ...
    typedef HelperCommonType<InternalAffineTransformType>::InternalAffineTransformPointerType InternalAffineTransformPointerType;
    typedef HelperCommonType<InternalAffineTransformType>::SingleInternalTransformItemType SingleInternalTransformItemType;
    ...
    static void ComputeAverageScaleParameters(
            InternalTransformListType &transform_list,
            ParametersType &average_parameters);

    static void ComputeAverageShearingParameters(
            InternalTransformListType &transform_list,
            ParametersType &average_parameters);

    static void ComputeAverageRotationParameters(
            InternalTransformListType &transform_list,
            ParametersType &average_parameters);

    static void ComputeAverageTranslationParameters(
            InternalTransformListType &transform_list,
            ParametersType &average_parameters);
...
public:
    ...
    typedef TTransform GenericAffineTransformType;
        ...
        itkStaticConstMacro(InputSpaceDimension, unsigned int, GenericAffineTransformType::InputSpaceDimension);itkStaticConstMacro(OutputSpaceDimension, unsigned int, GenericAffineTransformType::OutputSpaceDimension);itkStaticConstMacro(SpaceDimension, unsigned int, InputSpaceDimension);
    ...
    void PushBackAffineTransform(const GenericAffineTransformType* t,
            double weight);
...
protected:
    ...
    void ConvertGenericAffineToInternalAffineByFixingCenter(
            GenericAffineTransformPointerType &aff,
            InternalAffineTransformPointerType &iaff, const PointType & center);

    void ConvertInternalAffineToGenericAffine(
