/*=========================================================================
  ...
  Module:    $RCSfile: itkWarpTensorImageMultiTransformFilter.h,v $
  Language:  C++
  Date:      $Date: 2009/01/28 22:37:55 $
...
public:
    ...
    bool MultiTransformPoint(const PointType &point1, PointType &point2, bool bFisrtDeformNoInterp, const IndexType &index);
