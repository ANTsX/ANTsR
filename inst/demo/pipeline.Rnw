...
img = antsImageRead( system.file( "demo/data/KKI2009-01-fMRI.nii.gz" , package = "ANTsR" ) , 4 )
@
...
avg_img = new( "antsImage" , dimension = 3, pixeltype="float" )
@ 
...
moco_img = new( "antsImage" , pixeltype = "float" , dimension = 4 )
...
compcorr_corr_img = new( "antsImage" ,  4 )
compcorr_var_img = new( "antsImage" ,  3 )
@
...
seg_img_uint = new( "antsImage" , pixeltype = "unsigned int" , dimension = 3 )
@
...
prob_img_list = new( "antsImageList" , pixeltype = "float" , dimension = 3 )
...
cortmask_img = new( "antsImage" , pixeltype = "float" , dimension = 3 )
...
imglist = new( "antsImageList" , pixeltype = "double" , dimension = 3 )
